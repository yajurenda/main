...
function checkAchievements(count) {
  const messages = {
    ...
    69: ["69達成！", "シックスナイン！！"],
    364: ["364達成！", "みろよみろよ～～"],
    721: ["721達成！", "0を足したら0721、オナニー！！"],
    810: ["810達成！", "やりますねぇ！！(大声)"],
    1919: ["1919達成！", "イクぅ～～！♡//"],
    4545: ["4545達成！", "オナニー！！！"],
    114514: ["114514達成！", "いいよ、こいよ❗胸にかけて胸に‼️"],
    364364: ["364364達成！", "ほら、みろよみろよ"],
    810100081: ["810100081達成！", "野獣先輩！"],
    1145141919810: ["1145141919810達成！", "いいよこいよいくいくやじゅう"]
  };

  if (messages[count]) {
    const [title, message] = messages[count];
