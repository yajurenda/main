...
// --- 新規追加バッジ ---
{ id:114514, need:114514, name:"新たな道" },
{ id:364364, need:364364, name:"ホラ、見ろよ見ろよ、ホラ" },
{ id:8101000811919114514, need:8101000811919114514, name:"ヌゥン！ヘッ！ヘッ！\nア゛ア゛ア゛ア゛ァ゛ァ゛ァ゛ァ゛\nア゛↑ア゛↑ア゛↑ア゛↑ア゛ア゛ア゛ァ゛ァ゛ァ゛ァ゛！！！！\nウ゛ア゛ア゛ア゛ア゛ア゛ア゛ァ゛ァ゛ァ゛ァ゛ァ゛ァ゛ァ！！！！！\nフ ウ゛ウ゛ウ゛ゥ゛ゥ゛ゥ゛ン！！！！\nフ ウ゛ゥ゛ゥ゛ゥン！！！！(大迫真)" },
...
{ id:1145141919810100081, need:1145141919810100081, name:"新たな道" }, // ※「新たな道」は重複しますが、提示されたIDと必要回数で登録します
// --- 最終バッジ ---
...
/  エンディング条件のバッジID (変更なし)  /
const LASTBADGEID = 1145141919810; // "遊んでくれてありがとう❗"
...
renderBadges(); // バッジ表示の更新

// エンディング条件のバッジがアンロックされたかチェック
if(b.id === LASTBADGEID){
// 初回解禁時に選択モーダルを出す
showEndingOption();
}
